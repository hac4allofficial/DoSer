...
print("DoSer v1 Author : D4RK~D3VIL")
parser = argparse.ArgumentParser(
    description="DoSer, low bandwidth stress test tool for websites"
)
...
def main():
    ...
    logging.info("DoSing %s with %s sockets.", ip, socket_count)
